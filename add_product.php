...
<?php
 if(isset($_POST['add_product'])){
   ...
   if(empty($errors)){
     ...
     $query .=" name,quantity,buy_price,sale_price,categorie_id,media_id,date,minquantity";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$p_qty}', '{$p_buy}', '{$p_sale}', '{$p_cat}', '{$media_id}', '{$date}',' $p_mqty '";
     $query .=")";
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <a href="media.php" class="btn btn-primary">Subir imagen</a>
         </strong>
        </div>
        <div class="panel-body">
         <div class="col-md-12">
          <form method="post" action="add_product.php" class="clearfix">
               ...
               <div class="row">
                 <div class="col-md-4">
                   <div class="input-group">
                     ...
                     <input type="number" class="form-control" name="product-minquantity" placeholder="Cantidad Minima">
                  </div>
                 </div>
                 <div class="col-md-4">
                   <div class="input-group">
              ...
              <br> <br>
             <a href="product.php" class="btn btn-primary">Inventario</a>
          </form>
         </div>
        </div>
      </div>
